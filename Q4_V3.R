...
# Define indoor areas
indoor_areas <- c("Single Family Residence - Occupied", "Apartment Complex/Building",
                  "Gas or Service Station", "Convenience Store", "Retail Store",
                  "Bar/NightClub/DanceHall ETC.", "Condominium/Townhome Residence",
                  "Commercial Property Occupied/Vacant", "Medical Facility",
                  "Business Office", "Financial Institution",
                  "Entertainment/Sports Venue", "Religious Institution",
                  "Condominium/Townhome Building", "School/Daycare",
                  "Industrial/Manufacturing", "Storage Facility",
                  "Personal Services")
...
non_adv_data <- data %>%
  filter(Arrest.Location %in% indoor_areas,
...
# Create box plots and perform hypothesis testing for each indoor area
